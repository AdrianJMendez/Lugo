    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, user_Schema_1.usuarioSchema.find({ idUsuario: req.params.id })];
                case 1:
                    user = _a.sent();
                    res.send(user[0]);
                    res.end();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error al obtener usuarios:', error_1);
...
exports.obtenerlistausuario = function (req, res) {
    res.send('estas son las lista de perfiles del usuario' + req.params.id);
    res.end();
};
exports.obtenerallusers = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, user_Schema_1.usuarioSchema.find()];
                case 1:
                    allusers = _a.sent();
                    res.send(allusers);
                    res.end();
                ...
                case 2:
                    error_2 = _a.sent();
                    console.error('Error al obtener usuarios:', error_2);
                    res.status(500).send('Ocurrió un error al obtener usuarios.');
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
...
exports.guardarusuario = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var usuarioNuevo, usuarioGuardado, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, user_Schema_1.usuarioSchema.create(usuarioNuevo)];
                case 2:
                    usuarioGuardado = _a.sent();
                    res.send(usuarioGuardado);
                    res.end();
                    return [3 /*break*/, 4];
                case 3:
                    error_3 = _a.sent();
                    console.log('fallo', error_3);
                    return [3 /*break*/, 4];
